...
EndPoint2::EndPoint2()
{
    mEndPointData = CreateSockaddrin(mCurrentVersion);
}
...
void EndPoint2::SetInterface(const Interfaces i)
{
    switch(i)
    {
    case Interfaces::ANY :
...
/*
void EndPoint2::SetInterface(const Interfaces interface)
{
...
bool EndPoint2::operator==(const EndPoint2& other)
{
...
void EndPoint2::SetIPFamily(const IPversion version)
{
    switch(version) {
...
void EndPoint2::SetPortNumber(const int portNumber)
{
...
int EndPoint2::GetPortNumber() const
{
...
std::string EndPoint2::GetIpAddress() const
{
...
IPversion EndPoint2::GetIPFamily() const
{
...
void EndPoint2::SetIpAddress(const std::string& address)
{
    if (address.length() == 0)
...
sockaddr_in EndPoint2::CreateSockaddrin() const
{
